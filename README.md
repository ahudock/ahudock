...
[jrandom.com](https://www.jrandom.com "J. Random LLC (Andy Hudock)")  
[github.com/ahudock](https://www.github.com/ahudock "Andy Hudock | GitHub")  
[/in/andyhudock](https://www.linkedin.com/in/andyhudock "Andy Hudock | LinkedIn")  
...
- Programming, sysadmin, cybersecurity, design, IT, and project management
- Configured and administered servers (mainly baremetal/CentOS and AWS EC2)
- Designed, built, customized, and troubleshot mission-critical websites and
  eCommerce platforms across a wide range of sectors
- Served a culturally and geographically diverse clientele, some independently
  but predominantly with the small, PNW-based agency, ITPDX LLC (retired) as an
  integral member of their close-knit engineering team
...
- Contract ColdFusion programming and frontend development to renovate and
  deploy a high-profile, high-traffic, high-availability banking website
...
- Motorcycle Roadracing Novice Mentor, Track Day Instructor, and New Rider Coach
  throughout the Pacific Northwest since 2017
...
### Blue Devils Drum and Bugle Corps (Concord, CA), 1998--2000
- World Champion, Mxd Ensemble Champion, Horn Sergeant, Section Leader, Soloist
- MVP Brass (x2), MVP Marching, and Outstanding Veteran Marching awards

### Taipei Yuehfu Drum and Bugle Corps (Taipei, Taiwan), 2001
...
- Team persevered to finish endurance race despite challenging conditions and
  a stock 1968 Honda CL175 in serious disrepair (and nearly weren't last)
...
*Linux, Windows, macOS, AWS, EC2, DigitalOcean, Nginx, Apache, IIS, ColdFusion, virtualization, VirtualBox, VMware, Parallels, firewall, iptables, OpenVPN, DNS, DevOps, PHP, MySQL, API, WebSocket, HTML, HTML5, CSS, CSS3, LESS, JavaScript, jQuery, Prototype, AJAX, RWD, accessibility, SEO, PageSpeed, analytics, UI, UX, CI, Git, GitHub, BitBucket, SVN, Magento, OpenMage, Drupal, WordPress, forensics, Kali, pen testing, Metasploit, branding, logo design, graphic design, web design, print media, photography, Photoshop, Illustrator, recording, audio engineering, Ableton Live, Push, overclocking, quantitative analysis, derivatives, trading, thinkScript, etm*
